...
<!-- upstream-ref: 7fa443dc8bf8ca2f1ffd81c2472deb31b097b697 -->
<!-- local-implementation-ref: b5c166782d7de53c603c7ee6e3623e2c8472d9d6 -->
...
| 上游分支 | `main` |
| 已审阅上游提交 | `7fa443dc8bf8ca2f1ffd81c2472deb31b097b697` |
| 本地分支 | `dev` |
| 本地实现基线 | `b5c166782d7de53c603c7ee6e3623e2c8472d9d6` |
| 审阅日期 | 2026-09-14 |

本轮累计审阅范围为 `41fc5e13..7fa443dc`：
...
| 多账号调度 | 大体对齐 | D1 存账号，Durable Object 管租约、权重、优先级、并发和会话亲和；无进程内 executor 重绑定 | retry-round/exclusion、candidate filtering 公平性及 LCP hierarchy 分别跟进 Issue #94/#108/#117；registration epoch/refresh merge 跟进 #113；model-scoped cooldown、credential-change state invalidation、pre-mutation result policy、quota reset epoch/精确失效及管理侧 cooldown snapshot 真值来源跟进 #133；prevalidated candidate context 跟进 #138；候选全部永久认证失败后的 terminal aggregate 跟进 #100 |
