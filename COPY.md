...
<!-- upstream-ref: 30b2ac8996ea920285ef983dfaaa8e17624c8d21 -->
...
| 上游分支 | `main` |
| 已审阅上游提交 | `30b2ac8996ea920285ef983dfaaa8e17624c8d21` |
| 本地分支 | `dev` |
| 本地实现基线 | `32229caa914b069c8602851e7192c3ea3a810603` |
| 审阅日期 | 2026-09-13 |

本轮累计审阅范围为 `41fc5e13..30b2ac89`：
...
重点关键词：`response.failed`、`response.completed`、`response.done`、`response.output_item.done`、`response.reasoning_text`、`custom_tool_call`、`response.custom_tool_call_input`、`input_image`、`image_url`、`patternProperties`、Unicode property escape、incomplete/disconnected stream、usage limit、capacity、context length、reasoning replay/signature、`minimal` reasoning、`prompt_cache_key`、`Session-Id`、`X-Codex-Turn-State`、conversation identity、Responses-Lite、`spawn_agent`、`agent_message`、orphan delegation、model catalog、canonical template、provider capability、`gpt-image-2.5`、`User-Agent`、`Originator`、Codex cloaking、WebRTC、sideband、ICE/STUN/TCP candidate。
