...
const logging=readFileSync(join(root,"src/logging-settings.ts"),"utf8");
if(!logging.includes("logStorageEnabled")||!logging.includes("requestLoggingEnabled: true")||!logging.includes("toJSON()")) errors.push("日志开关与基础统计未在运行时解耦");
