...
const providerColumns: DataTableColumns<any> = [{ title: "供应来源", key: "provider_id" }, { title: "请求", key: "requests", render: (row) => fmt(row.requests) }, { title: "Token", key: "tokens", render: (row) => fmt(row.tokens) }];
const modelColumns: DataTableColumns<any> = [{ title: "模型", key: "public_model", ellipsis: { tooltip: true } }, { title: "请求", key: "requests", render: (row) => fmt(row.requests) }, { title: "Token", key: "tokens", render: (row) => fmt(row.tokens) }];
