...
<template><page-header title="内置渠道" description="协议、端点和授权流程由 CFlareAPI 固定维护；你只管理账号、调度和代理。"><n-button :loading="loading" @click="load"><template #icon><refresh-cw/></template>刷新</n-button></page-header>
